...
Capella v4 supports write operations (cluster create, user invitation, allowlist edits, API key rotation, App Service deployment), but the MCP server **deliberately doesn't expose them**.
